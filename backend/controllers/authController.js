...
exports.register = async (req, res) => {
  ...
  try {
    ...
    const payload = { id: user._id, email: user.email, name: user.name, phone: user.phone, country: user.country, createdAt: user.createdAt, isMember: user.isMember, role: user.role, promoApplied: !!user.promoCode };
